  ...
  <q-page>
        ...
        <b-table responsive :items="items_avatar" :fields="fields_avatar" table-class="table-vcenter card-table">
          ...
          <template v-slot:cell(person)="data">
            <div class="d-flex lh-sm py-1 align-items-center">
              ...
              <div class="flex-fill">
                <div class="strong">{{data.value.name}}</div>
                <div class="text-muted text-h5"><a href="#" class="text-reset">{{data.value.email}}</a></div>
              </div>
            </div>
          </template>
          ...
          <template v-slot:cell(title)="data">
            ...
            <div class="text-muted text-h5">{{data.value.sub}}</div>
          </template>
    ...
    <div class="card">
      ...
      >
        ...
        <template v-slot:cell(edit)="data">
          <div class="btn-list flex-nowrap">
            <b-dropdown variant="white" text="Actions" right size="sm">
              <b-dropdown-item href="#">Action</b-dropdown-item>
              <b-dropdown-item href="#">Another action</b-dropdown-item>
            </b-dropdown>
