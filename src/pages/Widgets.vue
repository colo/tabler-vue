              ...
              <div class="card-body">
                ...
                <p class="mb-0 text-muted">
                  <span class="text-green d-inline-flex align-items-center lh-1">
                    5.2% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="3 17 9 11 13 15 21 7" /><polyline points="14 7 21 7 21 14" /></svg>
                  </span>
              ...
              <div class="card-body">
                ...
                <p class="mb-0 text-muted">
                  <span class="text-red d-inline-flex align-items-center lh-1">
                    -3.1% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="3 7 9 13 13 9 21 17" /><polyline points="21 10 21 17 14 17" /></svg>
                  </span>
                  <span class="text-nowrap">Since last month</span>
                </p>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="card-title">
                  <a href="#">Tabler UI</a>
                  <span class="badge ml-2">v1.0</span>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon mr-2 text-muted" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="12" r="9" /><polyline points="12 7 12 12 15 15" /></svg>
