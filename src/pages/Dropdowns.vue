    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3">
        <div class="dropdown-menu dropdown-menu-demo">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item"><span class="avatar avatar-sm rounded mr-2" style="background-image: url(../static/avatars/000m.jpg)"></span>
            Paweł Kuna</a>
          <a href="#" class="dropdown-item"><span class="avatar avatar-sm rounded mr-2">JL</span>
            Jeffie Lewzey</a>
          <a href="#" class="dropdown-item"><span class="avatar avatar-sm rounded mr-2" style="background-image: url(../static/avatars/002m.jpg)"></span>
            Mallory Hulme</a>
          <div class="dropdown-divider"></div>
      ...
      <div class="col-sm-6 col-lg-3">
        ...
        <div class="dropdown-menu dropdown-menu-demo">
          <a href="#" class="dropdown-item"><span class="avatar rounded mr-2" style="background-image: url(../static/avatars/000m.jpg)"></span>
            Paweł Kuna</a>
          <a href="#" class="dropdown-item"><span class="avatar rounded mr-2">JL</span>
            Jeffie Lewzey</a>
          <a href="#" class="dropdown-item"><span class="avatar rounded mr-2" style="background-image: url(../static/avatars/002m.jpg)"></span>
            Mallory Hulme</a>
          <a href="#" class="dropdown-item"><span class="avatar rounded mr-2" style="background-image: url(../static/avatars/003m.jpg)"></span>
            Dunn Slane</a>
          <a href="#" class="dropdown-item"><span class="avatar rounded mr-2" style="background-image: url(../static/avatars/000f.jpg)"></span>
            Emmy Levet</a>
        </div>
      </div>
    </div>
