    ...
    <div class="row">
      ...
      <div class="col-9">
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/802a16cdf5ce3551.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/007m.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/0986f97be719fb9a.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded">SA</span>
                  <div>
                    <div>Sunny Airey</div>
                    <div class="text-muted">5 days ago</div>
                  </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/009m.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/1366fdc9b9b277e4.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/010m.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/5358d787242861c4.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/005f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/5614ec7eb9034d04.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/006f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/56614e12b2a7bd68.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded">AA</span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/77586f6ffa9fbc5e.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/008f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/552683cc4e5f0e11.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/009f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/3664593f945f0d8d.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/010f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/529078594c496ec5.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/011m.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/a74c41b6fb7fdf34.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/012m.jpg)"></span>
                  <div>
                    <div>Ban Rzehor</div>
                    <div class="text-muted">1 week and 1 day ago</div>
                  </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/a159fb2bff29fda4.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/011f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/a12804818c417ea3.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/012f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/abb0721ac43820f9.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/013m.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/d366fc3df37fe65b.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/013f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/da6119936bd7f566.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded">TB</span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/e8f47263360d96af.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/015f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/ecfed9fbf8a58836.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded">EB</span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/f7f04e6a834b1959.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/016f.jpg)"></span>
                  <div>
                    <div>Ninon Don</div>
                    <div class="text-muted">1 week and 1 day ago</div>
                  </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/f61b5f865012f200.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/015m.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/f746d9f7fa60be79.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/017f.jpg)"></span>
                  <div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
              <a href="#" class="d-block"><img src="../static/photos/ff54b43b56632883.jpg" class="card-img-top"></a>
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="avatar mr-3 rounded" style="background-image: url(../static/avatars/018f.jpg)"></span>
                  <div>
