                ...
                <div class="icons-list-wrap">
                  <ul class="icons-list">
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="accessible" data-toggle="tooltip" title="accessible">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><path d="M10 16.5l2 -3l2 3m-2 -3v-2l3 -1m-6 0l3 1" /><circle cx="12" cy="7.5" r=".5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="activity" data-toggle="tooltip" title="activity">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ad" data-toggle="tooltip" title="ad">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="adjustments" data-toggle="tooltip" title="adjustments">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="alarm" data-toggle="tooltip" title="alarm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="13" r="7" /><polyline points="12 10 12 13 14 13" /><line x1="7" y1="4" x2="4.25" y2="6" /><line x1="17" y1="4" x2="19.75" y2="6" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="alert-circle" data-toggle="tooltip" title="alert-circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="alert-triangle" data-toggle="tooltip" title="alert-triangle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="align-center" data-toggle="tooltip" title="align-center">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="align-justified" data-toggle="tooltip" title="align-justified">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="align-left" data-toggle="tooltip" title="align-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="align-right" data-toggle="tooltip" title="align-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="anchor" data-toggle="tooltip" title="anchor">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="aperture" data-toggle="tooltip" title="aperture">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="apps" data-toggle="tooltip" title="apps">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="archive" data-toggle="tooltip" title="archive">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="3" y="4" width="18" height="4" rx="2" /><path d="M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-10" /><line x1="10" y1="12" x2="14" y2="12" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-back-up" data-toggle="tooltip" title="arrow-back-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-back" data-toggle="tooltip" title="arrow-back">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-bar-down" data-toggle="tooltip" title="arrow-bar-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-bar-left" data-toggle="tooltip" title="arrow-bar-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-bar-right" data-toggle="tooltip" title="arrow-bar-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-bar-up" data-toggle="tooltip" title="arrow-bar-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-down-circle" data-toggle="tooltip" title="arrow-down-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="8" y1="12" x2="12" y2="16" /><line x1="12" y1="8" x2="12" y2="16" /><line x1="16" y1="12" x2="12" y2="16" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-down-left-circle" data-toggle="tooltip" title="arrow-down-left-circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-down-left" data-toggle="tooltip" title="arrow-down-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-down-right-circle" data-toggle="tooltip" title="arrow-down-right-circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-down-right" data-toggle="tooltip" title="arrow-down-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-down" data-toggle="tooltip" title="arrow-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-forward-up" data-toggle="tooltip" title="arrow-forward-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-forward" data-toggle="tooltip" title="arrow-forward">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-left-circle" data-toggle="tooltip" title="arrow-left-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="8" y1="12" x2="16" y2="12" /><line x1="8" y1="12" x2="12" y2="16" /><line x1="8" y1="12" x2="12" y2="8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-left" data-toggle="tooltip" title="arrow-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-narrow-down" data-toggle="tooltip" title="arrow-narrow-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-narrow-left" data-toggle="tooltip" title="arrow-narrow-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-narrow-right" data-toggle="tooltip" title="arrow-narrow-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-narrow-up" data-toggle="tooltip" title="arrow-narrow-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-right-circle" data-toggle="tooltip" title="arrow-right-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="16" y1="12" x2="8" y2="12" /><line x1="16" y1="12" x2="12" y2="16" /><line x1="16" y1="12" x2="12" y2="8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-right" data-toggle="tooltip" title="arrow-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-up-circle" data-toggle="tooltip" title="arrow-up-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="12" y1="8" x2="8" y2="12" /><line x1="12" y1="8" x2="12" y2="16" /><line x1="16" y1="12" x2="12" y2="8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-up-left-circle" data-toggle="tooltip" title="arrow-up-left-circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-up-left" data-toggle="tooltip" title="arrow-up-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-up-right-circle" data-toggle="tooltip" title="arrow-up-right-circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-up-right" data-toggle="tooltip" title="arrow-up-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrow-up" data-toggle="tooltip" title="arrow-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-diagonal-2" data-toggle="tooltip" title="arrows-diagonal-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-diagonal" data-toggle="tooltip" title="arrows-diagonal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-horizontal" data-toggle="tooltip" title="arrows-horizontal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-maximize" data-toggle="tooltip" title="arrows-maximize">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="16 4 20 4 20 8" /><line x1="14" y1="10" x2="20" y2="4" /><polyline points="8 20 4 20 4 16" /><line x1="4" y1="20" x2="10" y2="14" /><polyline points="16 20 20 20 20 16" /><line x1="14" y1="14" x2="20" y2="20" /><polyline points="8 4 4 4 4 8" /><line x1="4" y1="4" x2="10" y2="10" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-minimize" data-toggle="tooltip" title="arrows-minimize">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-sort" data-toggle="tooltip" title="arrows-sort">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="arrows-vertical" data-toggle="tooltip" title="arrows-vertical">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="artboard" data-toggle="tooltip" title="artboard">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="at" data-toggle="tooltip" title="at">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="atom" data-toggle="tooltip" title="atom">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="award" data-toggle="tooltip" title="award">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="backspace" data-toggle="tooltip" title="backspace">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ban" data-toggle="tooltip" title="ban">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bandage" data-toggle="tooltip" title="bandage">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="barcode" data-toggle="tooltip" title="barcode">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="battery-1" data-toggle="tooltip" title="battery-1">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="battery-2" data-toggle="tooltip" title="battery-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="battery-3" data-toggle="tooltip" title="battery-3">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="battery-4" data-toggle="tooltip" title="battery-4">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="battery-charging" data-toggle="tooltip" title="battery-charging">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="battery" data-toggle="tooltip" title="battery">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bed" data-toggle="tooltip" title="bed">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bell" data-toggle="tooltip" title="bell">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bike" data-toggle="tooltip" title="bike">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="5" cy="18" r="3" /><circle cx="19" cy="18" r="3" /><polyline points="12 19 12 15 9 12 14 8 16 11 19 11" /><circle cx="17" cy="5" r="1" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bluetooth" data-toggle="tooltip" title="bluetooth">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bold" data-toggle="tooltip" title="bold">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bolt" data-toggle="tooltip" title="bolt">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="book" data-toggle="tooltip" title="book">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bookmark" data-toggle="tooltip" title="bookmark">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-all" data-toggle="tooltip" title="border-all">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-bottom" data-toggle="tooltip" title="border-bottom">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-horizontal" data-toggle="tooltip" title="border-horizontal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-inner" data-toggle="tooltip" title="border-inner">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-left" data-toggle="tooltip" title="border-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-none" data-toggle="tooltip" title="border-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><g stroke-dasharray=".001 4"><line x1="4" y1="4" x2="20" y2="4" /><line x1="20" y1="4" x2="20" y2="20" /><line x1="20" y1="20" x2="4" y2="20" /><line x1="4" y1="20" x2="4" y2="4" /><line x1="4" y1="12" x2="20" y2="12" /><line x1="12" y1="4" x2="12" y2="20" /></g></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-outer" data-toggle="tooltip" title="border-outer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="2" /><g stroke-dasharray=".001 4"><line x1="4" y1="12" x2="20" y2="12" /><line x1="12" y1="4" x2="12" y2="20" /></g></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-radius" data-toggle="tooltip" title="border-radius">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-right" data-toggle="tooltip" title="border-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-top" data-toggle="tooltip" title="border-top">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="border-vertical" data-toggle="tooltip" title="border-vertical">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="box" data-toggle="tooltip" title="box">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="braces" data-toggle="tooltip" title="braces">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="brackets" data-toggle="tooltip" title="brackets">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="briefcase" data-toggle="tooltip" title="briefcase">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="brightness-down" data-toggle="tooltip" title="brightness-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="brightness-up" data-toggle="tooltip" title="brightness-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="brightness" data-toggle="tooltip" title="brightness">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="12" y1="3" x2="12" y2="21" /><path d="M12 9l4.65 -4.65" /><path d="M12 14.3l7.37 -7.37" /><path d="M12 19.6l8.85 -8.85" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="browser" data-toggle="tooltip" title="browser">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="1" /><line x1="4" y1="8" x2="20" y2="8" /><line x1="8" y1="4" x2="8" y2="8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="brush" data-toggle="tooltip" title="brush">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bucket" data-toggle="tooltip" title="bucket">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bug" data-toggle="tooltip" title="bug">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building-arch" data-toggle="tooltip" title="building-arch">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building-bridge-2" data-toggle="tooltip" title="building-bridge-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building-bridge" data-toggle="tooltip" title="building-bridge">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building-church" data-toggle="tooltip" title="building-church">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building-hospital" data-toggle="tooltip" title="building-hospital">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building-store" data-toggle="tooltip" title="building-store">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="building" data-toggle="tooltip" title="building">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bulb-off" data-toggle="tooltip" title="bulb-off">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bulb" data-toggle="tooltip" title="bulb">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="calculator" data-toggle="tooltip" title="calculator">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="calendar-event" data-toggle="tooltip" title="calendar-event">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><rect x="8" y="15" width="2" height="2" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="calendar-minus" data-toggle="tooltip" title="calendar-minus">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><line x1="10" y1="16" x2="14" y2="16" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="calendar-plus" data-toggle="tooltip" title="calendar-plus">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><line x1="10" y1="16" x2="14" y2="16" /><line x1="12" y1="14" x2="12" y2="18" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="calendar" data-toggle="tooltip" title="calendar">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><line x1="11" y1="15" x2="12" y2="15" /><line x1="12" y1="15" x2="12" y2="18" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="camera" data-toggle="tooltip" title="camera">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="car" data-toggle="tooltip" title="car">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="7" cy="17" r="2" /><circle cx="17" cy="17" r="2" /><path d="M5 17h-2v-6l2-5h9l4 5h1a2 2 0 0 1 2 2v4h-2m-4 0h-6m-6 -6h15m-6 0v-5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="caret-down" data-toggle="tooltip" title="caret-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="caret-left" data-toggle="tooltip" title="caret-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="caret-right" data-toggle="tooltip" title="caret-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="caret-up" data-toggle="tooltip" title="caret-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cash" data-toggle="tooltip" title="cash">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cast" data-toggle="tooltip" title="cast">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-area-line" data-toggle="tooltip" title="chart-area-line">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-area" data-toggle="tooltip" title="chart-area">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-bar" data-toggle="tooltip" title="chart-bar">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-candle" data-toggle="tooltip" title="chart-candle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-donut" data-toggle="tooltip" title="chart-donut">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-line" data-toggle="tooltip" title="chart-line">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chart-pie" data-toggle="tooltip" title="chart-pie">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="check" data-toggle="tooltip" title="check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="checkbox" data-toggle="tooltip" title="checkbox">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="checks" data-toggle="tooltip" title="checks">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevron-down" data-toggle="tooltip" title="chevron-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevron-left" data-toggle="tooltip" title="chevron-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevron-right" data-toggle="tooltip" title="chevron-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevron-up" data-toggle="tooltip" title="chevron-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevrons-down" data-toggle="tooltip" title="chevrons-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevrons-left" data-toggle="tooltip" title="chevrons-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevrons-right" data-toggle="tooltip" title="chevrons-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chevrons-up" data-toggle="tooltip" title="chevrons-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="chrome" data-toggle="tooltip" title="chrome">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="circle-check" data-toggle="tooltip" title="circle-check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="circle-minus" data-toggle="tooltip" title="circle-minus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="circle-plus" data-toggle="tooltip" title="circle-plus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="circle-x" data-toggle="tooltip" title="circle-x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="circle" data-toggle="tooltip" title="circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="click" data-toggle="tooltip" title="click">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="clipboard-check" data-toggle="tooltip" title="clipboard-check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="clipboard-list" data-toggle="tooltip" title="clipboard-list">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="clipboard-x" data-toggle="tooltip" title="clipboard-x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="clipboard" data-toggle="tooltip" title="clipboard">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="clock" data-toggle="tooltip" title="clock">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cloud-download" data-toggle="tooltip" title="cloud-download">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cloud-rain" data-toggle="tooltip" title="cloud-rain">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cloud-snow" data-toggle="tooltip" title="cloud-snow">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M7 18a4.6 4.4 0 0 1 0 -9h0a5 4.5 0 0 1 11 2h1a3.5 3.5 0 0 1 0 7" /><path d="M11 15v.01m0 3v.01m0 3v.01m4 -4v.01m0 3v.01" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cloud-storm" data-toggle="tooltip" title="cloud-storm">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cloud-upload" data-toggle="tooltip" title="cloud-upload">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cloud" data-toggle="tooltip" title="cloud">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="code" data-toggle="tooltip" title="code">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="coin" data-toggle="tooltip" title="coin">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="color-swatch" data-toggle="tooltip" title="color-swatch">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="columns" data-toggle="tooltip" title="columns">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="command" data-toggle="tooltip" title="command">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="compass" data-toggle="tooltip" title="compass">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="copy" data-toggle="tooltip" title="copy">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="copyright" data-toggle="tooltip" title="copyright">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-down-left" data-toggle="tooltip" title="corner-down-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-down-right" data-toggle="tooltip" title="corner-down-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-left-down" data-toggle="tooltip" title="corner-left-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-left-up" data-toggle="tooltip" title="corner-left-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-right-down" data-toggle="tooltip" title="corner-right-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-right-up" data-toggle="tooltip" title="corner-right-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-up-left" data-toggle="tooltip" title="corner-up-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="corner-up-right" data-toggle="tooltip" title="corner-up-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="credit-card" data-toggle="tooltip" title="credit-card">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="crop" data-toggle="tooltip" title="crop">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="currency-bitcoin" data-toggle="tooltip" title="currency-bitcoin">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="currency-dollar" data-toggle="tooltip" title="currency-dollar">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="currency-euro" data-toggle="tooltip" title="currency-euro">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="currency-pound" data-toggle="tooltip" title="currency-pound">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="currency-rupee" data-toggle="tooltip" title="currency-rupee">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="currency-yen" data-toggle="tooltip" title="currency-yen">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="cut" data-toggle="tooltip" title="cut">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="7" cy="17" r="3" /><circle cx="17" cy="17" r="3" /><line x1="9.15" y1="14.85" x2="18" y2="4" /><line x1="6" y1="4" x2="14.85" y2="14.85" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dashboard" data-toggle="tooltip" title="dashboard">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="13" r="2" /><line x1="13.45" y1="11.55" x2="15.5" y2="9.5" /><path d="M6.4 20a9 9 0 1 1 11.2 0Z" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="database" data-toggle="tooltip" title="database">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-desktop" data-toggle="tooltip" title="device-desktop">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-floppy" data-toggle="tooltip" title="device-floppy">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-gamepad" data-toggle="tooltip" title="device-gamepad">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-laptop" data-toggle="tooltip" title="device-laptop">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-mobile-vibration" data-toggle="tooltip" title="device-mobile-vibration">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-mobile" data-toggle="tooltip" title="device-mobile">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-speaker" data-toggle="tooltip" title="device-speaker">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-tablet" data-toggle="tooltip" title="device-tablet">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="device-tv" data-toggle="tooltip" title="device-tv">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="devices" data-toggle="tooltip" title="devices">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="diamond" data-toggle="tooltip" title="diamond">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dice" data-toggle="tooltip" title="dice">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="2" /><circle cx="8.5" cy="8.5" r=".5" /><circle cx="15.5" cy="8.5" r=".5" /><circle cx="15.5" cy="15.5" r=".5" /><circle cx="8.5" cy="15.5" r=".5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="directions" data-toggle="tooltip" title="directions">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="disabled-2" data-toggle="tooltip" title="disabled-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="17" cy="6" r="2" /><path d="M9 11a4.97 4.97 0 1 0 3.95 7.95" /><path d="M19 20l-4 -5h-4l3 -5l-4 -3l-4 1" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="disabled" data-toggle="tooltip" title="disabled">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="disc" data-toggle="tooltip" title="disc">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="1" /><path d="M7 12a5 5 0 0 1 5 -5" /><path d="M12 17a5 5 0 0 0 5 -5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="discount" data-toggle="tooltip" title="discount">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dots-circle-horizontal" data-toggle="tooltip" title="dots-circle-horizontal">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="8" y1="12" x2="8" y2="12.01" /><line x1="12" y1="12" x2="12" y2="12.01" /><line x1="16" y1="12" x2="16" y2="12.01" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dots-diagonal-2" data-toggle="tooltip" title="dots-diagonal-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dots-diagonal" data-toggle="tooltip" title="dots-diagonal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dots-vertical" data-toggle="tooltip" title="dots-vertical">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dots" data-toggle="tooltip" title="dots">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="download" data-toggle="tooltip" title="download">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="drag-drop-2" data-toggle="tooltip" title="drag-drop-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="drag-drop" data-toggle="tooltip" title="drag-drop">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="droplet" data-toggle="tooltip" title="droplet">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ear" data-toggle="tooltip" title="ear">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="edit" data-toggle="tooltip" title="edit">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M9 7 h-3a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-3" /><path d="M9 15h3l8.5 -8.5a1.5 1.5 0 0 0 -3 -3l-8.5 8.5v3" /><line x1="16" y1="5" x2="19" y2="8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="egg" data-toggle="tooltip" title="egg">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="emphasis" data-toggle="tooltip" title="emphasis">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="eraser" data-toggle="tooltip" title="eraser">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="exposure" data-toggle="tooltip" title="exposure">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="4.6" y1="19.4" x2="19.4" y2="4.6" /><path d="M7 9h4m-2 -2v4" /><path d="M13 16h4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="external-link" data-toggle="tooltip" title="external-link">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="eye" data-toggle="tooltip" title="eye">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="2" /><path d="M2 12l1.5 2a11 11 0 0 0 17 0l1.5 -2" /><path d="M2 12l1.5 -2a11 11 0 0 1 17 0l1.5 2" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="face-id" data-toggle="tooltip" title="face-id">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-check" data-toggle="tooltip" title="file-check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-code" data-toggle="tooltip" title="file-code">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-download" data-toggle="tooltip" title="file-download">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-horizontal" data-toggle="tooltip" title="file-horizontal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-invoice" data-toggle="tooltip" title="file-invoice">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-minus" data-toggle="tooltip" title="file-minus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-music" data-toggle="tooltip" title="file-music">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-plus" data-toggle="tooltip" title="file-plus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-shredder" data-toggle="tooltip" title="file-shredder">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-text" data-toggle="tooltip" title="file-text">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file-x" data-toggle="tooltip" title="file-x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="file" data-toggle="tooltip" title="file">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="filter" data-toggle="tooltip" title="filter">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="fingerprint" data-toggle="tooltip" title="fingerprint">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="flag" data-toggle="tooltip" title="flag">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="flask" data-toggle="tooltip" title="flask">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="flip-horizontal" data-toggle="tooltip" title="flip-horizontal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="flip-vertical" data-toggle="tooltip" title="flip-vertical">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="float-center" data-toggle="tooltip" title="float-center">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="float-left" data-toggle="tooltip" title="float-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="float-right" data-toggle="tooltip" title="float-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="floppy-disk" data-toggle="tooltip" title="floppy-disk">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="focus-2" data-toggle="tooltip" title="focus-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="focus" data-toggle="tooltip" title="focus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="folder-minus" data-toggle="tooltip" title="folder-minus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="folder-plus" data-toggle="tooltip" title="folder-plus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="folder-x" data-toggle="tooltip" title="folder-x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="folder" data-toggle="tooltip" title="folder">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="folders" data-toggle="tooltip" title="folders">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="forbid-2" data-toggle="tooltip" title="forbid-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="forbid" data-toggle="tooltip" title="forbid">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="frame" data-toggle="tooltip" title="frame">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="friends" data-toggle="tooltip" title="friends">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="gauge" data-toggle="tooltip" title="gauge">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="1" /><line x1="13.41" y1="10.59" x2="16" y2="8" /><path d="M7 12a5 5 0 0 1 5 -5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ghost" data-toggle="tooltip" title="ghost">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="gift" data-toggle="tooltip" title="gift">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git-branch" data-toggle="tooltip" title="git-branch">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git-commit" data-toggle="tooltip" title="git-commit">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git-compare" data-toggle="tooltip" title="git-compare">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git-fork" data-toggle="tooltip" title="git-fork">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git-merge" data-toggle="tooltip" title="git-merge">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="7" cy="18" r="2" /><circle cx="7" cy="6" r="2" /><circle cx="17" cy="12" r="2" /><line x1="7" y1="8" x2="7" y2="16" /><path d="M7 8a4 4 0 0 0 4 4h4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git-pull-request" data-toggle="tooltip" title="git-pull-request">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="glass-full" data-toggle="tooltip" title="glass-full">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="glass" data-toggle="tooltip" title="glass">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="15" x2="12" y2="21" /><path d="M16 4l1 6a5 5 0 0 1 -10 0l1 -6z" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="globe" data-toggle="tooltip" title="globe">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="10" r="4" /><path d="M6.75 16a8.015 8.015 0 1 0 9.25 -13" /><line x1="12" y1="18" x2="12" y2="22" /><line x1="8" y1="22" x2="16" y2="22" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="grid-dots" data-toggle="tooltip" title="grid-dots">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="grid" data-toggle="tooltip" title="grid">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="hash" data-toggle="tooltip" title="hash">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="5" y1="9" x2="19" y2="9" /><line x1="5" y1="15" x2="19" y2="15" /><line x1="11" y1="4" x2="7" y2="20" /><line x1="17" y1="4" x2="13" y2="20" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="headphones" data-toggle="tooltip" title="headphones">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="headset" data-toggle="tooltip" title="headset">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="heart" data-toggle="tooltip" title="heart">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="help" data-toggle="tooltip" title="help">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="12" y1="17" x2="12" y2="17.01" /><path d="M12 13.5a1.5 1.5 0 0 1 1 -1.5a2.6 2.6 0 1 0 -3 -4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="home-2" data-toggle="tooltip" title="home-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="5 12 3 12 12 3 21 12 19 12" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><rect x="10" y="12" width="4" height="4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="home" data-toggle="tooltip" title="home">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="5 12 3 12 12 3 21 12 19 12" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ice-cream" data-toggle="tooltip" title="ice-cream">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="id" data-toggle="tooltip" title="id">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="inbox" data-toggle="tooltip" title="inbox">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="indent-decrease" data-toggle="tooltip" title="indent-decrease">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="indent-increase" data-toggle="tooltip" title="indent-increase">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="20" y1="6" x2="9" y2="6" /><line x1="20" y1="12" x2="13" y2="12" /><line x1="20" y1="18" x2="9" y2="18" /><path d="M4 8l4 4l-4 4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="infinity" data-toggle="tooltip" title="infinity">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="info-circle" data-toggle="tooltip" title="info-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="12" y1="8" x2="12.01" y2="8" /><polyline points="11 12 12 12 12 16 13 16" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="info-square" data-toggle="tooltip" title="info-square">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="italic" data-toggle="tooltip" title="italic">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="key" data-toggle="tooltip" title="key">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="8" cy="15" r="4" /><line x1="10.85" y1="12.15" x2="19" y2="4" /><line x1="18" y1="5" x2="20" y2="7" /><line x1="15" y1="8" x2="17" y2="10" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="keyboard" data-toggle="tooltip" title="keyboard">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="language" data-toggle="tooltip" title="language">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layers-difference" data-toggle="tooltip" title="layers-difference">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layers-intersect" data-toggle="tooltip" title="layers-intersect">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layers-subtract" data-toggle="tooltip" title="layers-subtract">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layers-union" data-toggle="tooltip" title="layers-union">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-2" data-toggle="tooltip" title="layout-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-align-bottom" data-toggle="tooltip" title="layout-align-bottom">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-align-center" data-toggle="tooltip" title="layout-align-center">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-align-left" data-toggle="tooltip" title="layout-align-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-align-middle" data-toggle="tooltip" title="layout-align-middle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-align-right" data-toggle="tooltip" title="layout-align-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-align-top" data-toggle="tooltip" title="layout-align-top">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-bottombar" data-toggle="tooltip" title="layout-bottombar">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-columns" data-toggle="tooltip" title="layout-columns">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-distribute-horizontal" data-toggle="tooltip" title="layout-distribute-horizontal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-distribute-vertical" data-toggle="tooltip" title="layout-distribute-vertical">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-navbar" data-toggle="tooltip" title="layout-navbar">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-rows" data-toggle="tooltip" title="layout-rows">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-sidebar-right" data-toggle="tooltip" title="layout-sidebar-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout-sidebar" data-toggle="tooltip" title="layout-sidebar">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="layout" data-toggle="tooltip" title="layout">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="lego" data-toggle="tooltip" title="lego">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="letter-case" data-toggle="tooltip" title="letter-case">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="18" cy="16" r="3" /><line x1="21" y1="13" x2="21" y2="19" /><path d="M3 19l5 -13l5 13" /><line x1="5" y1="14" x2="11" y2="14" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="license" data-toggle="tooltip" title="license">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="lifebuoy" data-toggle="tooltip" title="lifebuoy">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="line-height" data-toggle="tooltip" title="line-height">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="link" data-toggle="tooltip" title="link">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="list-check" data-toggle="tooltip" title="list-check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="list" data-toggle="tooltip" title="list">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="live-photo" data-toggle="tooltip" title="live-photo">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="1" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="9" stroke-dasharray=".001 4.03" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="location" data-toggle="tooltip" title="location">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="lock-open" data-toggle="tooltip" title="lock-open">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="lock" data-toggle="tooltip" title="lock">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="login" data-toggle="tooltip" title="login">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M14 8v-2a2 2 0 0 0 -2 -2h-7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h7a2 2 0 0 0 2 -2v-2" /><path d="M20 12h-13l3 -3m0 6l-3 -3" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="logout" data-toggle="tooltip" title="logout">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M14 8v-2a2 2 0 0 0 -2 -2h-7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h7a2 2 0 0 0 2 -2v-2" /><path d="M7 12h14l-3 -3m0 6l3 -3" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="magnet" data-toggle="tooltip" title="magnet">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mail-opened" data-toggle="tooltip" title="mail-opened">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mail" data-toggle="tooltip" title="mail">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="man" data-toggle="tooltip" title="man">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="5" r="2" /><path d="M10 22v-5l-1-1v-4a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4l-1 1v5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="map-2" data-toggle="tooltip" title="map-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="map-pin" data-toggle="tooltip" title="map-pin">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="11" r="3" /><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 0 1 -2.827 0l-4.244-4.243a8 8 0 1 1 11.314 0z" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="map" data-toggle="tooltip" title="map">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="maximize" data-toggle="tooltip" title="maximize">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="menu" data-toggle="tooltip" title="menu">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="message-2" data-toggle="tooltip" title="message-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="message-circle" data-toggle="tooltip" title="message-circle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="message-dots" data-toggle="tooltip" title="message-dots">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="message" data-toggle="tooltip" title="message">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M4 21v-13a3 3 0 0 1 3 -3h10a3 3 0 0 1 3 3v6a3 3 0 0 1 -3 3h-9l-4 4" /><line x1="8" y1="9" x2="16" y2="9" /><line x1="8" y1="13" x2="14" y2="13" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="messages" data-toggle="tooltip" title="messages">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="microphone" data-toggle="tooltip" title="microphone">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="minimize" data-toggle="tooltip" title="minimize">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="minus" data-toggle="tooltip" title="minus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mood-confuzed" data-toggle="tooltip" title="mood-confuzed">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="9" y1="10" x2="9.01" y2="10" /><line x1="15" y1="10" x2="15.01" y2="10" /><path d="M9.5 16a10 10 0 0 1 6 -1.5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mood-happy" data-toggle="tooltip" title="mood-happy">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="9" y1="9" x2="9.01" y2="9" /><line x1="15" y1="9" x2="15.01" y2="9" /><path d="M8 13a4 4 0 1 0 8 0m0 0H8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mood-neutral" data-toggle="tooltip" title="mood-neutral">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="9" y1="10" x2="9.01" y2="10" /><line x1="15" y1="10" x2="15.01" y2="10" /><line x1="9" y1="15" x2="15" y2="15" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mood-sad" data-toggle="tooltip" title="mood-sad">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="9" y1="10" x2="9.01" y2="10" /><line x1="15" y1="10" x2="15.01" y2="10" /><path d="M9.5 15.25a3.5 3.5 0 0 1 5 0" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mood-smile" data-toggle="tooltip" title="mood-smile">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="9" y1="10" x2="9.01" y2="10" /><line x1="15" y1="10" x2="15.01" y2="10" /><path d="M9.5 15a3.5 3.5 0 0 0 5 0" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mood-tongue" data-toggle="tooltip" title="mood-tongue">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="9" y1="10" x2="9.01" y2="10" /><line x1="15" y1="10" x2="15.01" y2="10" /><path d="M10 14v2a2 2 0 0 0 4 0v-2m1 0h-6" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="moon" data-toggle="tooltip" title="moon">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mouse" data-toggle="tooltip" title="mouse">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="movie" data-toggle="tooltip" title="movie">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="mug" data-toggle="tooltip" title="mug">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="music" data-toggle="tooltip" title="music">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="6" cy="17" r="3" /><circle cx="16" cy="17" r="3" /><polyline points="9 17 9 4 19 4 19 17" /><line x1="9" y1="8" x2="19" y2="8" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="new-section" data-toggle="tooltip" title="new-section">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="news" data-toggle="tooltip" title="news">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="note" data-toggle="tooltip" title="note">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="notebook" data-toggle="tooltip" title="notebook">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="notes" data-toggle="tooltip" title="notes">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="notification" data-toggle="tooltip" title="notification">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="omega" data-toggle="tooltip" title="omega">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="outlet" data-toggle="tooltip" title="outlet">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="2" /><circle cx="9" cy="12" r=".5" fill="currentColor" /><circle cx="15" cy="12" r=".5" fill="currentColor" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="package" data-toggle="tooltip" title="package">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="12 3 20 7.5 20 16.5 12 21 4 16.5 4 7.5 12 3" /><line x1="12" y1="12" x2="20" y2="7.5" /><line x1="12" y1="12" x2="12" y2="21" /><line x1="12" y1="12" x2="4" y2="7.5" /><line x1="16" y1="5.25" x2="8" y2="9.75" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="paint" data-toggle="tooltip" title="paint">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="palette" data-toggle="tooltip" title="palette">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="paperclip" data-toggle="tooltip" title="paperclip">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="parentheses" data-toggle="tooltip" title="parentheses">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="parking" data-toggle="tooltip" title="parking">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="pencil" data-toggle="tooltip" title="pencil">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="phone-call" data-toggle="tooltip" title="phone-call">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="phone-incoming" data-toggle="tooltip" title="phone-incoming">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="phone-outgoing" data-toggle="tooltip" title="phone-outgoing">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="phone-pause" data-toggle="tooltip" title="phone-pause">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="phone" data-toggle="tooltip" title="phone">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M4 4h5l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v5a1 1 0 0 1 -1 1a16 16 0 0 1 -16 -16a1 1 0 0 1 1 -1" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="photo" data-toggle="tooltip" title="photo">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="pillow" data-toggle="tooltip" title="pillow">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="plane-arrival" data-toggle="tooltip" title="plane-arrival">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="plane-departure" data-toggle="tooltip" title="plane-departure">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M15 12h5a2 2 0 0 1 0 4h-15l-3 -6h3l2 2h3l-2 -7h3z" transform="rotate(-15 12 12) translate(0 -1)" /><line x1="3" y1="21" x2="21" y2="21" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="plane" data-toggle="tooltip" title="plane">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="plug" data-toggle="tooltip" title="plug">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="plus" data-toggle="tooltip" title="plus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="point" data-toggle="tooltip" title="point">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="power" data-toggle="tooltip" title="power">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="presentation" data-toggle="tooltip" title="presentation">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="printer" data-toggle="tooltip" title="printer">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="prompt" data-toggle="tooltip" title="prompt">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="puzzle" data-toggle="tooltip" title="puzzle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="qrcode" data-toggle="tooltip" title="qrcode">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="record-mail" data-toggle="tooltip" title="record-mail">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="recycle" data-toggle="tooltip" title="recycle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="refresh" data-toggle="tooltip" title="refresh">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="registered" data-toggle="tooltip" title="registered">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="repeat-once" data-toggle="tooltip" title="repeat-once">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="repeat" data-toggle="tooltip" title="repeat">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="replace" data-toggle="tooltip" title="replace">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="rotate-2" data-toggle="tooltip" title="rotate-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="rotate-clockwise-2" data-toggle="tooltip" title="rotate-clockwise-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="rotate-clockwise" data-toggle="tooltip" title="rotate-clockwise">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="rotate" data-toggle="tooltip" title="rotate">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="route" data-toggle="tooltip" title="route">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="6" cy="19" r="2" /><circle cx="18" cy="5" r="2" /><path d="M12 19h4.5a3.5 3.5 0 0 0 0 -7h-8a3.5 3.5 0 0 1 0 -7h3.5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="router" data-toggle="tooltip" title="router">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="rss" data-toggle="tooltip" title="rss">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ruler" data-toggle="tooltip" title="ruler">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="scale" data-toggle="tooltip" title="scale">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="scan" data-toggle="tooltip" title="scan">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="scissors" data-toggle="tooltip" title="scissors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="6" cy="7" r="3" /><circle cx="6" cy="17" r="3" /><line x1="8.6" y1="8.6" x2="19" y2="19" /><line x1="8.6" y1="15.4" x2="19" y2="5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="search" data-toggle="tooltip" title="search">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="selector" data-toggle="tooltip" title="selector">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="send" data-toggle="tooltip" title="send">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="separator" data-toggle="tooltip" title="separator">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="server" data-toggle="tooltip" title="server">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="settings" data-toggle="tooltip" title="settings">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" /><circle cx="12" cy="12" r="3" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="shape" data-toggle="tooltip" title="shape">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="share" data-toggle="tooltip" title="share">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="6" cy="12" r="3" /><circle cx="18" cy="6" r="3" /><circle cx="18" cy="18" r="3" /><line x1="8.7" y1="10.7" x2="15.3" y2="7.3" /><line x1="8.7" y1="13.3" x2="15.3" y2="16.7" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="shield-check" data-toggle="tooltip" title="shield-check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="shield-x" data-toggle="tooltip" title="shield-x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="shield" data-toggle="tooltip" title="shield">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="shopping-cart" data-toggle="tooltip" title="shopping-cart">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="9" cy="19" r="2" /><circle cx="17" cy="19" r="2" /><path d="M3 3h2l2 12a3 3 0 0 0 3 2h7a3 3 0 0 0 3 -2l1 -7h-15.2" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sitemap" data-toggle="tooltip" title="sitemap">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="slice" data-toggle="tooltip" title="slice">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="slideshow" data-toggle="tooltip" title="slideshow">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sort-ascending" data-toggle="tooltip" title="sort-ascending">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="4" y1="6" x2="11" y2="6" /><line x1="4" y1="12" x2="11" y2="12" /><line x1="4" y1="18" x2="13" y2="18" /><polyline points="15 9 18 6 21 9" /><line x1="18" y1="6" x2="18" y2="18" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sort-descending" data-toggle="tooltip" title="sort-descending">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="4" y1="6" x2="13" y2="6" /><line x1="4" y1="12" x2="11" y2="12" /><line x1="4" y1="18" x2="11" y2="18" /><polyline points="15 15 18 18 21 15" /><line x1="18" y1="6" x2="18" y2="18" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="square-check" data-toggle="tooltip" title="square-check">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="square-minus" data-toggle="tooltip" title="square-minus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="square-plus" data-toggle="tooltip" title="square-plus">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="9" y1="12" x2="15" y2="12" /><line x1="12" y1="9" x2="12" y2="15" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="square-x" data-toggle="tooltip" title="square-x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="square" data-toggle="tooltip" title="square">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="stack" data-toggle="tooltip" title="stack">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="star" data-toggle="tooltip" title="star">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sticker" data-toggle="tooltip" title="sticker">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="strikethrough" data-toggle="tooltip" title="strikethrough">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="subscript" data-toggle="tooltip" title="subscript">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sum" data-toggle="tooltip" title="sum">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sun" data-toggle="tooltip" title="sun">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="4" /><path d="M3 12h1M12 3v1M20 12h1M12 20v1M5.6 5.6l.7 .7M18.4 5.6l-.7 .7M17.7 17.7l.7 .7M6.3 17.7l-.7 .7" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="superscript" data-toggle="tooltip" title="superscript">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="switch-horizontal" data-toggle="tooltip" title="switch-horizontal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="switch-vertical" data-toggle="tooltip" title="switch-vertical">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="switch" data-toggle="tooltip" title="switch">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="table" data-toggle="tooltip" title="table">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="4" y1="10" x2="20" y2="10" /><line x1="10" y1="4" x2="10" y2="20" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="tag" data-toggle="tooltip" title="tag">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="target" data-toggle="tooltip" title="target">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="tax" data-toggle="tooltip" title="tax">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="temperature-celsius" data-toggle="tooltip" title="temperature-celsius">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="6" cy="8" r="2" /><path d="M20 9a3 3 0 0 0 -3 -3h-1a3 3 0 0 0 -3 3v6a3 3 0 0 0 3 3h1a3 3 0 0 0 3 -3" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="temperature-fahrenheit" data-toggle="tooltip" title="temperature-fahrenheit">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="temperature" data-toggle="tooltip" title="temperature">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="template" data-toggle="tooltip" title="template">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="terminal" data-toggle="tooltip" title="terminal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="test-pipe" data-toggle="tooltip" title="test-pipe">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="text-wrap" data-toggle="tooltip" title="text-wrap">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="4" y1="6" x2="20" y2="6" /><line x1="4" y1="18" x2="9" y2="18" /><path d="M4 12h13a3 3 0 0 1 0 6h-4l2 -2m0 4l-2 -2" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="thumb-down" data-toggle="tooltip" title="thumb-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="thumb-up" data-toggle="tooltip" title="thumb-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ticket" data-toggle="tooltip" title="ticket">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="toggle-left" data-toggle="tooltip" title="toggle-left">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="toggle-right" data-toggle="tooltip" title="toggle-right">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="tool" data-toggle="tooltip" title="tool">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="tools" data-toggle="tooltip" title="tools">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="trash" data-toggle="tooltip" title="trash">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><line x1="4" y1="7" x2="20" y2="7" /><line x1="10" y1="11" x2="10" y2="17" /><line x1="14" y1="11" x2="14" y2="17" /><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" /><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="trending-down" data-toggle="tooltip" title="trending-down">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="trending-up" data-toggle="tooltip" title="trending-up">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="triangle" data-toggle="tooltip" title="triangle">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="trophy" data-toggle="tooltip" title="trophy">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="truck" data-toggle="tooltip" title="truck">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="7" cy="17" r="2" /><circle cx="17" cy="17" r="2" /><path d="M5 17h-2v-11a1 1 0 0 1 1 -1h9v12m-4 0h6m4 0h2v-6h-8m0 -5h5l3 5" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="typography" data-toggle="tooltip" title="typography">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="underline" data-toggle="tooltip" title="underline">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="unlink" data-toggle="tooltip" title="unlink">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="upload" data-toggle="tooltip" title="upload">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="urgent" data-toggle="tooltip" title="urgent">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="user-check" data-toggle="tooltip" title="user-check">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="8.5" cy="7" r="4" /><path d="M2 21v-2a4 4 0 0 1 4 -4h5a4 4 0 0 1 4 4v2" /><path d="M16 11l2 2l4 -4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="user-minus" data-toggle="tooltip" title="user-minus">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="8.5" cy="7" r="4" /><path d="M2 21v-2a4 4 0 0 1 4 -4h5a4 4 0 0 1 4 4v2" /><line x1="16" y1="11" x2="22" y2="11" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="user-plus" data-toggle="tooltip" title="user-plus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="user-x" data-toggle="tooltip" title="user-x">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="8.5" cy="7" r="4" /><path d="M2 21v-2a4 4 0 0 1 4 -4h5a4 4 0 0 1 4 4v2" /><path d="M17 9l4 4m0 -4l-4 4" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="user" data-toggle="tooltip" title="user">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="viewfinder" data-toggle="tooltip" title="viewfinder">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="virus" data-toggle="tooltip" title="virus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="volume-2" data-toggle="tooltip" title="volume-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="volume-3" data-toggle="tooltip" title="volume-3">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="volume" data-toggle="tooltip" title="volume">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wallet" data-toggle="tooltip" title="wallet">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wand" data-toggle="tooltip" title="wand">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wifi-0" data-toggle="tooltip" title="wifi-0">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wifi-1" data-toggle="tooltip" title="wifi-1">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wifi-2" data-toggle="tooltip" title="wifi-2">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wifi" data-toggle="tooltip" title="wifi">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="woman" data-toggle="tooltip" title="woman">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="world" data-toggle="tooltip" title="world">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><line x1="3.6" y1="9" x2="20.4" y2="9" /><line x1="3.6" y1="15" x2="20.4" y2="15" /><path d="M11.5 3a17 17 0 0 0 0 18" /><path d="M12.5 3a17 17 0 0 1 0 18" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="x" data-toggle="tooltip" title="x">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="zoom-in" data-toggle="tooltip" title="zoom-in">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="10" cy="10" r="7" /><line x1="7" y1="10" x2="13" y2="10" /><line x1="10" y1="7" x2="10" y2="13" /><line x1="21" y1="21" x2="15" y2="15" /></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="zoom-out" data-toggle="tooltip" title="zoom-out">
            ...
            <div class="row" data-icon-preview>
              ...
              <div class="col">
                <div class="icons-list-wrap">
                  <ul class="icons-list">
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="android" data-toggle="tooltip" title="android">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="apple" data-toggle="tooltip" title="apple">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="asana" data-toggle="tooltip" title="asana">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="atlassian" data-toggle="tooltip" title="atlassian">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="basecamp" data-toggle="tooltip" title="basecamp">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="behance" data-toggle="tooltip" title="behance">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bing" data-toggle="tooltip" title="bing">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bitbucket" data-toggle="tooltip" title="bitbucket">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bitcoin" data-toggle="tooltip" title="bitcoin">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="blogger" data-toggle="tooltip" title="blogger">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="bootstrap" data-toggle="tooltip" title="bootstrap">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="buddy" data-toggle="tooltip" title="buddy">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="circleci" data-toggle="tooltip" title="circleci">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="codepen" data-toggle="tooltip" title="codepen">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="codeship" data-toggle="tooltip" title="codeship">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="css3" data-toggle="tooltip" title="css3">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="digitalocean" data-toggle="tooltip" title="digitalocean">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="disqus" data-toggle="tooltip" title="disqus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="docker" data-toggle="tooltip" title="docker">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dribbble" data-toggle="tooltip" title="dribbble">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="dropbox" data-toggle="tooltip" title="dropbox">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="facebook" data-toggle="tooltip" title="facebook">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="figma" data-toggle="tooltip" title="figma">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="flickr" data-toggle="tooltip" title="flickr">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="foursquare" data-toggle="tooltip" title="foursquare">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="git" data-toggle="tooltip" title="git">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="github" data-toggle="tooltip" title="github">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="gitlab" data-toggle="tooltip" title="gitlab">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="google" data-toggle="tooltip" title="google">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="googleplus" data-toggle="tooltip" title="googleplus">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="gravatar" data-toggle="tooltip" title="gravatar">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="hipchat" data-toggle="tooltip" title="hipchat">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="html5" data-toggle="tooltip" title="html5">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="instagram" data-toggle="tooltip" title="instagram">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="invision" data-toggle="tooltip" title="invision">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="javascript" data-toggle="tooltip" title="javascript">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="kickstarter" data-toggle="tooltip" title="kickstarter">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="linkedin" data-toggle="tooltip" title="linkedin">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="icon icon-md" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="medium" data-toggle="tooltip" title="medium">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="meetup" data-toggle="tooltip" title="meetup">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="messenger" data-toggle="tooltip" title="messenger">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="netflix" data-toggle="tooltip" title="netflix">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="pagekit" data-toggle="tooltip" title="pagekit">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="paypal" data-toggle="tooltip" title="paypal">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="pinterest" data-toggle="tooltip" title="pinterest">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="producthunt" data-toggle="tooltip" title="producthunt">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sass" data-toggle="tooltip" title="sass">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="sentry" data-toggle="tooltip" title="sentry">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="skype" data-toggle="tooltip" title="skype">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="slack" data-toggle="tooltip" title="slack">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="snapchat" data-toggle="tooltip" title="snapchat">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="spotify" data-toggle="tooltip" title="spotify">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="strava" data-toggle="tooltip" title="strava">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="stripe" data-toggle="tooltip" title="stripe">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="tabler" data-toggle="tooltip" title="tabler">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="telegram" data-toggle="tooltip" title="telegram">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="tumblr" data-toggle="tooltip" title="tumblr">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="icon icon-md" fill="currentColor"><path d="M14.563 24c-5.093 0-7.031-3.756-7.031-6.411V9.747H5.116V6.648c3.63-1.313 4.512-4.596 4.71-6.469C9.84.051 9.941 0 9.999 0h3.517v6.114h4.801v3.633h-4.82v7.47c.016 1.001.375 2.371 2.207 2.371h.09c.631-.02 1.486-.205 1.936-.419l1.156 3.425c-.436.636-2.4 1.374-4.156 1.404h-.178l.011.002z"/></svg>
                      </a>
                    </li>
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="twitter" data-toggle="tooltip" title="twitter">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="typescript" data-toggle="tooltip" title="typescript">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="uber" data-toggle="tooltip" title="uber">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="uikit" data-toggle="tooltip" title="uikit">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="vimeo" data-toggle="tooltip" title="vimeo">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="vk" data-toggle="tooltip" title="vk">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wechat" data-toggle="tooltip" title="wechat">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="whatsapp" data-toggle="tooltip" title="whatsapp">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="wordpress" data-toggle="tooltip" title="wordpress">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="ycombinator" data-toggle="tooltip" title="ycombinator">
                    ...
                    <li class="icons-list-item">
                      <a href="#" @click.prevent class="text-reset" data-toggle-icon="youtube" data-toggle="tooltip" title="youtube">
        ...
        elements.forEach(function (element) {
          element.addEventListener('click', function (e) {
            ...
            var icon = this.dataset.toggleIcon,
              svg = this.innerHTML,
              editor = self.getClosest(this, '[data-icon-preview]')
