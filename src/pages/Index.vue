...
<script>
import Vue from 'vue'
import { BButton, BDropdown, BDropdownItem, BModal, VBModal } from 'bootstrap-vue'
...
// important: don't use `import` here, it would get hoisted before the previous line.
require('jqvmap')
