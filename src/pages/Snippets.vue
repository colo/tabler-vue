    ...
    <div class="row">
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card">
          <div class="card-body text-center">
            <div class="mb-3">
              <span class="avatar avatar-xl" style="background-image: url(./static/avatars/005f.jpg)"></span>
            </div>
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card">
          <div class="card-body text-center">
            <div class="mb-3">
              <span class="avatar avatar-xl" style="background-image: url(./static/avatars/006f.jpg)"></span>
            </div>
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card">
          <div class="card-body text-center">
            <div class="mb-3">
              <span class="avatar avatar-xl">AA</span>
            </div>
      ...
      <div class="col-md-6 col-xl-3">
        <a class="card card-link" href="#">
          <div class="card-cover text-center" style="background-image: url(./static/photos/5358d787242861c4.jpg)">
            <span class="avatar avatar-xl avatar-thumb" style="background-image: url(./static/avatars/013m.jpg)"></span>
          </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-xl-3">
        <a class="card card-link" href="#">
          <div class="card-cover text-center card-cover-blurred" style="background-image: url(./static/photos/5614ec7eb9034d04.jpg)">
            <span class="avatar avatar-xl avatar-thumb" style="background-image: url(./static/avatars/013f.jpg)"></span>
          </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-xl-3">
        <a class="card card-link" href="#">
          <div class="card-cover text-center card-cover-blurred" style="background-image: url(./static/photos/5749e5c54a61a45e.jpg)">
            <span class="avatar avatar-xl avatar-thumb">TB</span>
          </div>
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card card-sm">
          <div class="card-body d-flex align-items-center">
            <div class="mr-3">
              <div class="chart-sparkline chart-sparkline-square" id="sparkline-78">
                <peity
                  :type="'pie'"
                  :options="{
                    width: 40,
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card card-sm">
          <div class="card-body d-flex align-items-center">
            <div class="mr-3">
              <div class="chart-sparkline chart-sparkline-square" id="sparkline-79">
                <peity
                  :type="'pie'"
                  :options="{
                    width: 40,
      ...
      <div class="col-md-6 col-lg-4">
        ...
        >
          <template v-slot:right>
            <div class="chart-sparkline" id="sparkline-80">
              <peity
                :type="'line'"
                :options="{
                  width: 64,
        ...
        <t-card-mini
          title="1,700"
          subtitle="Users"
          icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z'/><path d='M12 20l-7 -7a4 4 0 0 1 6.5 -6a.9 .9 0 0 0 1 0a4 4 0 0 1 6.5 6l-7 7' /></svg>"
          icon-class="bg-red text-white stamp mr-3"
        >
          <template v-slot:right>
            <div class="chart-sparkline" id="sparkline-81">
              <peity
                :type="'bar'"
                :options="{
                  width: 64,
        ...
        <div class="card card-sm">
          <div class="card-body d-flex align-items-center">
            <span class="bg-green text-white stamp mr-3"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="icon" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>
            </span>
            <div class="mr-3 lh-sm">
              <div class="strong">
                1,700
            ...
            <div class="ml-auto">
              <div class="chart-sparkline" id="sparkline-82">
                <peity
                  :type="'bar'"
                  :options="{
                    width: 64,
        ...
        <div class="card card-sm">
          <div class="card-body d-flex align-items-center">
            ...
            <div class="ml-auto">
              <div class="chart-sparkline chart-sparkline-square" id="sparkline-83">
                <peity
                  :type="'pie'"
                  :options="{
                    width: 40,
        ...
        <div class="card card-sm">
          <div class="card-body d-flex align-items-center">
            ...
            <div class="ml-auto">
              <div class="chart-sparkline chart-sparkline-square" id="sparkline-84">
                <peity
                  :type="'pie'"
                  :options="{
                    width: 40,
        ...
        <div class="card card-sm">
          <div class="card-body d-flex align-items-center">
            ...
            <div class="mr-3 lh-sm">
              <div class="strong">
                1,700
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-sm ml-1 text-red" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="3 7 9 13 13 9 21 17" /><polyline points="21 10 21 17 14 17" /></svg>
              </div>
              <div class="text-muted">Users</div>
            </div>
          </div>
...
<span class="p">}</span></code></pre>
      ...
      <div class="col-md-6 col-lg-4">
          ...
          <div class="card-body">
            ...
            <p class="mb-0 text-muted">
              <span class="text-green d-inline-flex align-items-center lh-1">
                5.2% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="3 17 9 11 13 15 21 7" /><polyline points="14 7 21 7 21 14" /></svg>
              </span>
        ...
        <div class="card" data-color=grey>
          <div class="card-body">
            <div class="float-right stamp bg-green text-white">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="7" r="4" /><path d="M5.5 21v-2a4 4 0 0 1 4 -4h5a4 4 0 0 1 4 4v2" /></svg>
            </div>
          ...
          <div class="card-body">
            ...
            <p class="mb-0 text-muted">
              <span class="text-red d-inline-flex align-items-center lh-1">
                -3.1% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><polyline points="3 7 9 13 13 9 21 17" /><polyline points="21 10 21 17 14 17" /></svg>
              </span>
              <span class="text-nowrap">Since last month</span>
            </p>
          </div>
      ...
      <div class="col-md-6 col-lg-4">
          ...
          <div class="card-body">
            ...
            <div class="card-meta d-flex justify-content-between">
              <div class="d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon mr-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><path d="M5 12l5 5l10 -10" /></svg>
                <span>5/10</span>
              </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" class="icon mr-2 text-muted" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"/><circle cx="12" cy="12" r="9" /><polyline points="12 7 12 12 9 15" /></svg>
